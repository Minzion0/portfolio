...
val experience2 = Experience(
        ...
        skillRepository.saveAll(mutableListOf(java,kotlin,spring,mysql,mariadb,redis,myBatis))
        ...
        project1.addDetails(
            mutableListOf(
                ProjectDetail(content = "SQL쿼리 수정을 통한 n+1 문제 해결하여 API 호출 속도 61ms -> 5ms 개선", url = null,isActive = true),
                ProjectDetail(content = "Github Repository", url = "https://github.com/Minzion0/food_roulette",isActive = true)
            )
        )
        ...
        project2.addDetails(
            mutableListOf(
                ...
                ProjectDetail(content = "Github Repository", url = "https://github.com/Minzion0/smartGradeVer.2",isActive = true)
            )
        )
